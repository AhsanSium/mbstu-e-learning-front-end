...
import avtar from '../../../../public/assets/img/blog/avtar.jpg';
    ...
    render() {
        ...
        if (this.state.singlePost) {
            ...
            post = (<>
                ...
                <h2 className='h2'>{post1.title}</h2>
                <div className="SingleBlog_avatar">
                    <Link rel="noopener noreferrer" >
                        <img src={avtar} alt="img" width="75" height="75" />
                    </Link>
                ...
                <div className="singlePost_content pt-3">
                    ...
                    <div className="text py-5 mb-4">
                        <p className='h5' style={{ whiteSpace: 'pre-wrap' }} >{post1.content}</p>
                    </div>
                </div>
            </>
            )
        ...
        return (<>
            <div>
                ...
                {isLoading}
                {iserror}
                <div className="container-md py-4 SingleBlog mt-5">
